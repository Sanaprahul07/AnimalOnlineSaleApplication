            ...
            <div className="row g-4">
              ...
              <div className="col-lg-3 col-md-6">
                ...
                <div className="category-box">
                  ...
                  <Link to="/animals/Cow" className="menu-item">
                    🐄 Cow
                  </Link>

                  <Link to="/animals/Buffalo" className="menu-item">
                    🐃 Buffalo
                  </Link>

                  <Link to="/animals/Goat" className="menu-item">
                    🐐 Goat
                  </Link>

                  <Link to="/animals/Sheep" className="menu-item">
                    🐑 Sheep
                  </Link>
              ...
              <div className="col-lg-3 col-md-6">
                ...
                <div className="category-box">
                  ...
                  <Link to="/animals/Dog" className="menu-item">
                    🐕 Dog
                  </Link>

                  <Link to="/animals/Cat" className="menu-item">
                    🐈 Cat
                  </Link>
              ...
              <div className="col-lg-3 col-md-6">
                ...
                <div className="category-box">
                  ...
                  <Link to="/animals/Poultry" className="menu-item">
                    🐔 Poultry
                  </Link>
              ...
              <div className="col-lg-3 col-md-6">
                ...
                <div className="category-box">
                  ...
                  <Link to="/animals/Horse" className="menu-item">
                    🐎 Horse
                  </Link>
