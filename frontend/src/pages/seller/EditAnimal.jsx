...
function EditAnimal() {
  ...
  useEffect(() => {
    getAnimalById(id)
      ...
      .catch((error) => {
        ...
        setError("Unable to load animal details.");
  ...
  const handleSubmit = (event) => {
    ...
    updateAnimal(id, animalData)
      ...
      .catch((error) => {
        ...
        setError("Unable to update animal.");
      })
      .finally(() => {
        setSaving(false);
      });
  ...
  return (
    <div className="container-fluid p-4">
      ...
      <div className="mb-4">
        <h2 className="fw-bold text-success">Edit Animal 🐄</h2>

        <p className="text-muted">Update animal information</p>
      </div>
      ...
      <div className="card shadow border-0">
        <div className="card-header bg-success text-white">
          <h5 className="mb-0">Update Animal</h5>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="d-flex gap-2">
              ...
              <button
                ...
                onClick={() => navigate("/seller/animals")}
              >
                Cancel
              </button>
            </div>
