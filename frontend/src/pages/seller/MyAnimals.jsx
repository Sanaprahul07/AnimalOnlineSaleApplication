...
import { getAnimalsBySeller, deleteAnimal } from "../../services/AnimalService";
...
function MyAnimals() {
  ...
  const loadSellerAnimals = () => {
    ...
    getAnimalsBySeller(sellerId)
      .then((response) => {
        console.log("Seller Animals Response:", response.data);
      ...
      .catch((error) => {
        console.error("Error loading seller animals:", error);
        ...
        setError("Unable to load seller animals.");
      })
      .finally(() => {
        setLoading(false);
      });
  ...
  const handleDelete = (id) => {
    ...
    deleteAnimal(id)
      .then((response) => {
        console.log("Delete Animal Response:", response.data);
  ...
  return (
    <div className="container-fluid p-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h2 className="fw-bold text-success">My Animals 🐄</h2>

          <p className="text-muted mb-0">Animals added by seller</p>
        </div>

        <a href="/seller/add-animal" className="btn btn-success">
          ➕ Add Animal
        </a>
      </div>
      ...
      {!loading && animals.length > 0 && (
        <div className="card shadow border-0">
          ...
          <div className="card-header bg-success text-white">
            <h5 className="mb-0">My Animals ({animals.length})</h5>
          </div>
